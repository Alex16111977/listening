  ...
  texts: [
    ...
    /* ═══ TEIL 4 — 1 длинное интервью ═══ */
    {
      ...
      sentenceTranslations: {
        ...
        'Unser Lehrer schickt uns außerdem vor und nach jeder Stunde auch andere Dateien mit verschiedenen Sachen, wie z.B.': { literal: 'Наш учитель посылает нам кроме-того перед и после каждого часа также другие файлы с различными вещами, как напр.', literary: 'Наш учитель также присылает нам до и после каждого занятия файлы с разными материалами, например' },
        'Übungen oder Texte und Videos.': { literal: 'упражнения или тексты и видео', literary: 'упражнениями, текстами и видео.' },
