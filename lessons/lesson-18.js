  ...
  texts: [
    ...
    },
    {
      ...
      sentenceTranslations: {
        ...
        'Als Ersatztermin für die Aufführung ist der 31. März vorgesehen.': { literal: 'Как замещающий срок для представления есть 31 марта предусмотрен', literary: 'В качестве новой даты спектакля запланировано 31 марта.' },
