  ...
  texts: [
    ...
    /* ═══ TEIL 4 — 1 длинное интервью ═══ */
    {
      ...
      sentenceTranslations: {
        ...
        'In der Schule war... hat mein Sportlehrer mir gesagt, bei welchem Fußballverein ich mich anmelden soll.': { literal: 'В школе был... имеет мой спорт-учитель мне сказанным, при каком футбольном-клубе я себя записать должна.', literary: 'В школе... мой учитель физкультуры сказал мне, в какой футбольный клуб мне записаться.' },
